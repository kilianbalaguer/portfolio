export const translations = {
  en: {
    ...
    // About
    aboutTitle: "About Me",
  aboutP1: "Hey! I'm Kilian, a 15-year-old developer from the Netherlands. I started coding when I was 11, so I've been coding for 4 years. I love building apps, games, and websites that solve real problems.",
    ...
    footerTech: "Built with React, Next.js, TypeScript, Tailwind CSS, Framer Motion, and hosted on Vercel.",
  },
  fr: {
    // Navbar
    home: "Accueil",
  ...
  aboutP1: "Salut ! Je suis Kilian, un développeur de 15 ans des Pays-Bas. J'ai commencé à coder à 11 ans, donc je code depuis 4 ans. J'adore créer des applications, des jeux et des sites qui résolvent de vrais problèmes.",
    ...
    contactDescription: "Vous avez un projet en tête ? Travaillons ensemble pour créer quelque chose d'incroyable.",
    contactEmail: "EMAIL",
    ...
    footerAbout: "À propos de ce site",
    footerTech: "Construit avec React, Next.js, TypeScript, Tailwind CSS, Framer Motion, et hébergé sur Vercel.",
  },
  ar: {
    // Navbar
    home: "الرئيسية",
    ...
    // About
    aboutTitle: "نبذة عني",
  aboutP1: "مرحباً! أنا كيليان، مطور يبلغ من العمر 15 عامًا من هولندا. بدأت البرمجة عندما كان عمري 11 سنوات، لذلك أعمل في البرمجة منذ 4 سنوات. أحب بناء التطبيقات والألعاب والمواقع التي تحل مشاكل حقيقية.",
    ...
    // Experience
    experienceTitle: "رحلتي",
    
    // Contact
    contactTitle: "اتصل بي",
    contactDescription: "لديك مشروع في ذهنك؟ لنعمل معًا لإنشاء شيء مذهل.",
    contactEmail: "البريد الإلكتروني",
    namePlaceholder: "اسمك",
    emailPlaceholder: "بريدك الإلكتروني",
    messagePlaceholder: "رسالتك",
    send: "إرسال",
    successMessage: "شكرًا للتواصل معنا! سنرد عليك في أقرب وقت ممكن.",
    
    // Footer
    footerRights: "جميع الحقوق محفوظة.",
    footerAbout: "حول هذا الموقع",
    footerTech: "تم البناء باستخدام React و Next.js و TypeScript و Tailwind CSS و Framer Motion، واستضافته على Vercel.",
  },
  nl: {
    // Navbar
    home: "Home",
    ...
    // About
    aboutTitle: "Over Mij",
  aboutP1: "Hey! Ik ben Kilian, een 15-jarige ontwikkelaar uit Nederland. Ik begon met coderen toen ik 11 was, dus ik codeer al 4 jaar. Ik bouw graag apps, games en websites die echte problemen oplossen.",
    ...
    // Experience
    experienceTitle: "Mijn Reis",
    
    // Contact
    contactTitle: "Neem Contact Op",
    contactDescription: "Heb je een project in gedachten? Laten we samenwerken om iets geweldigs te creëren.",
    contactEmail: "EMAIL",
    ...
    footerTech: "Gebouwd met React, Next.js, TypeScript, Tailwind CSS, Framer Motion, en gehost op Vercel.",
  },
  de: {
    // Navbar
    home: "Startseite",
  ...
  aboutP1: "Hey! Ich bin Kilian, ein 15-jähriger Entwickler aus den Niederlanden. Ich habe mit 11 Jahren angefangen zu programmieren, also programmiere ich seit 4 Jahren. Ich liebe es, Apps, Spiele und Websites zu bauen, die echte Probleme lösen.",
    ...
    // Experience
    experienceTitle: "Meine Reise",
    
    // Contact
    contactTitle: "Kontakt",
    contactDescription: "Hast du ein Projekt im Kopf? Lass uns zusammenarbeiten, um etwas Erstaunliches zu schaffen.",
    contactEmail: "E-MAIL",
    ...
    footerAbout: "Über diese Seite",
    footerTech: "Erstellt mit React, Next.js, TypeScript, Tailwind CSS, Framer Motion und gehostet auf Vercel.",
  },
  es: {
    // Navbar
    home: "Inicio",
  ...
  aboutP1: "¡Hola! Soy Kilian, un desarrollador de 15 años de los Países Bajos. Empecé a programar cuando tenía 11 años, así que llevo 4 años programando. Me encanta crear aplicaciones, juegos y sitios web que resuelven problemas reales.",
    ...
    // Experience
    experienceTitle: "Mi Viaje",
    
    // Contact
    contactTitle: "Contacto",
    contactDescription: "¿Tienes un proyecto en mente? Trabajemos juntos para crear algo increíble.",
    contactEmail: "CORREO",
    ...
    footerAbout: "Acerca de este sitio",
    footerTech: "Creado con React, Next.js, TypeScript, Tailwind CSS, Framer Motion y alojado en Vercel.",
  },
  ko: {
    // Navbar
    home: "홈",
    ...
    // About
    aboutTitle: "소개",
  aboutP1: "안녕하세요! 저는 네덜란드에서 온 15세 개발자 킬리안입니다. 11살 때 코딩을 시작했고, 그래서 4년 동안 코딩해왔습니다. 실제 문제를 해결하는 앱, 게임, 웹사이트를 만드는 것을 좋아합니다.",
    ...
    // Experience
    experienceTitle: "나의 여정",
    
    // Contact
    contactTitle: "연락하기",
    contactDescription: "프로젝트가 있으신가요? 함께 멋진 것을 만들어봅시다.",
    contactEmail: "이메일",
    namePlaceholder: "이름",
    emailPlaceholder: "이메일",
    messagePlaceholder: "메시지",
    send: "보내기",
    successMessage: "연락해 주셔서 감사합니다! 최대한 빨리 답변드리겠습니다.",
    
    // Footer
    footerRights: "모든 권리 보유.",
    footerAbout: "이 사이트에 대해",
    footerTech: "React, Next.js, TypeScript, Tailwind CSS, Framer Motion으로 제작되었으며 Vercel에서 호스팅됩니다.",
  },
} as const;
